...
import com.atombot.app.ws.SpringApplicationContext;
import com.atombot.app.ws.service.UserService;
import com.atombot.app.ws.shared.dto.UserDto;
import com.atombot.app.ws.ui.model.request.UserLoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain,
		...
		res.addHeader(SecurityConstants.HEADER_STING, SecurityConstants.TOKEN_PREFIX + token);
